...
//
// 【★但这几种文件必须手动升版本号】
// favicon.svg、icons/ 里的图标、manifest.webmanifest ——
// 它们**文件名固定不变**，内容改了名字也不改，
// 仓库里存着旧的就会一直拿旧的（图标换了手机上却不变，就是这么来的）。
//
// 所以：**只要动了上面这几种文件，就必须把 CACHE_VERSION 升一位**，
// 新工人上任时会把旧仓库整个删掉，全部重新下载。
// ============================================================

const CACHE_VERSION = 'nanofit-v2'
